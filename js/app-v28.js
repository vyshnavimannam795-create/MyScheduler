...
function resetBookingCard() {
  ...
  if (bookingBody) {
    bookingBody.innerHTML = `
      <div style="display:flex; justify-content:center; margin-bottom:12px; color:var(--text-light)">
      ...
      <p class="text-sm font-semibold" style="margin-bottom:4px;text-align:center">You don't have any upcoming bookings.</p>
      <p class="text-xs text-muted" style="text-align:center">Book a meeting to see your details here.</p>`;
  }
}
